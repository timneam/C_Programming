#include <stdio.h>
#define Quiz1_weight 0.15
#define Quiz2_weight 0.15
#define AE_weight 0.35
#define CP_weight 0.05
...
int main()
{
    ...
    for (i = 0; i < num; ++i)
    {
        ...
        printf("\n \n Enter the AE marks: ");
        scanf("%f", &student[i].AE);
        printf("\n \n Enter the CP marks: ");
        scanf("%f", &student[i].CP);
        printf("\n \n Enter the exam marks: ");
        scanf("%f", &student[i].exam);
        /* compute total for this student*/
        student[i].total = (student[i].Quiz1) * Quiz1_weight + (student[i].Quiz2) * Quiz2_weight + (student[i].AE) * AE_weight + (student[i].CP) * CP_weight + (student[i].exam) * exam_weight;
    }
    /*print heading and table*/
    printf("\n \n ----------------------------------------------");
    printf("----------------------------------------------------");
    printf("\n NAME ID Quiz1 Quiz2 AE CP Exam Total");
    printf("\n ----------------------------------------------");
    printf("----------------------------------------------------");
    for (i = 0; i < num; ++i)
    {
        ...
        printf("%4.2f\t\t %4.2f\t\t %4.2f\t\t %4.2f\t\t %4.2f\t\t %4.2f\t\t", student[i].Quiz1, student[i].Quiz2, student[i].AE, student[i].CP, student[i].exam, student[i].total);
    }
    printf("\n ----------------------------------------------");
    printf("----------------------------------------------------");
}